    ...
    <div className="min-h-screen bg-transparent text-white py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-gray-800/20 rounded-xl border border-gray-700">
            <div className="p-4 bg-gray-800 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
              <Newspaper className="w-8 h-8 text-gray-500" />
            </div>
            <h3 className="text-xl font-bold text-white mb-2">Belum ada berita</h3>
            <p className="text-gray-400">Nantikan informasi terbaru dari kami selanjutnya!</p>
          </div>
        ) : (
        ...
        {selectedNews && (
          <div className="fixed inset-0 z-50 bg-black/90 flex items-start justify-center p-4 pt-16 overflow-y-auto" onClick={() => setSelectedNews(null)}>
